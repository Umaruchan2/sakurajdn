            ...
            if (chat.welcome) {
              ...
              let lea = await new knights.Goodbye()
                ...
                .toAttachment()
                       ...
                       await this.sendHydrated(id, text, wm, action === 'add' ? wel.toBuffer() : lea.toBuffer(), sgc, (action == 'add' ? 'Hai Selamat Datang👋' : 'Bye Beban Keluarga 👋'), user.split`@`[0], 'telpon', [
      ['🎀 Menu', '/menu'],
      ['🤨 Test', '/ping'],
...
global.dfail = (type, m, conn) => {
    ...
    if (msg) return conn.reply(m.chat, msg, m, { contextInfo: { externalAdReply: {title: wm, body: 'Yang masuk jdi animek 😏👆', sourceUrl: sgc, thumbnail: fs.readFileSync('./thumbnail.jpg')}}}
}
